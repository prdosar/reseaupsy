...
{
    public class EditClientForTherapist
    {
        ...
        public EditClientForTherapist(ReseauPsyEntities context, DetailClientDatas datas, int clientId)
        {
            _context = context;
            _datas = datas;
        ...
        private void CreateClientInfo()
        {
            ...
            {
                GetClientInfos lastClientInfo = new GetClientInfos(_context, _client.Id);
                lastClientInfo.GetMostRecentClientInfo();

                clientInfo.TherapistHourlyWage = lastClientInfo.TherapistHourlyWage;
                clientInfo.ClientHourlyCost = lastClientInfo.ClientHourlyCost;
            }

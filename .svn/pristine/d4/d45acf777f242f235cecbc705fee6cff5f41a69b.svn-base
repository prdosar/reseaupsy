...
{
    public class DetailTherapistDatas
    {
        ...
        public List<string> Wages { get; set; }
        ...
        public List<int> PracticeSectorIds { get; set; }
        public List<int> OrientationIds { get; set; }
        public List<int> SkillIds { get; set; }

        public DetailTherapistDatas()
        {
            ...
            PracticeSectorIds = new List<int>();
            OrientationIds = new List<int>();
            SkillIds = new List<int>();
            ConsultationTypesIds = new List<int>();
            Wages = new List<string>();
        }
    }
}